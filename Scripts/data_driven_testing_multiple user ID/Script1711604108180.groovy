...
Mobile.setText(findTestObject('Object Repository/1.login_scenario/android.widget.EditText'), UserName, 0)

Mobile.tap(findTestObject('Object Repository/1.login_scenario/android.widget.EditText (1)'), 0)

Mobile.setText(findTestObject('Object Repository/1.login_scenario/android.widget.EditText (1)'), Password, 0)
