...
Mobile.tap(findTestObject('Object Repository/Registration/android.widget.TextView - Forgot Password'), 0)

Mobile.tap(findTestObject('Object Repository/Registration/android.widget.TextView - Return to Login'), 0)
