...
Mobile.setText(findTestObject('Object Repository/1.login_scenario/android.widget.EditText'), 'k@techcarrot.ae', 0)

Mobile.tap(findTestObject('Object Repository/1.login_scenario/android.widget.EditText (1)'), 0)

Mobile.setText(findTestObject('Object Repository/1.login_scenario/android.widget.EditText (1)'), 'Testing@123', 0)

Mobile.tap(findTestObject('Object Repository/1.login_scenario/log_button_ok'), 0)

Mobile.tap(findTestObject('Object Repository/6.Registration/incorrectemail_error_ok_B'), 0)
