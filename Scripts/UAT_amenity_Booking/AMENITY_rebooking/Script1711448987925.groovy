...
Mobile.tap(findTestObject('Object Repository/SLOTS DATE/android.view.ViewGroup (1)'), 0)

Mobile.tap(findTestObject('Object Repository/SLOTS DATE/android.view.ViewGroup'), 0)
